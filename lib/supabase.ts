...
console.debug('[SUPABASE INIT]', { urlExists: !!url, keyExists: !!key });
...
const initStatus: SupabaseInitStatus = {
  ...
  urlExists: !!url,
  keyExists: !!key,
  urlValid: !!url && isValidSupabaseUrl(url),
  keyValid: !!key && isValidAnonKey(key),
};
...
const globalKey = '__easytutor_supabase_client__';
  ...
  try {
    const client = createClient(url, key, {
      ...
      global: {
        ...
        headers: {
          'x-client-info': 'easytutor-mobile',
        },
      },
    });
