  ...
  return (
    <SafeAreaView className="flex-1 bg-[#0d0f12]" edges={['top']}>
      <View className="px-5 py-6 border-b border-[#2a2f3d] flex-row items-center justify-between">
        ...
        <TouchableOpacity 
          onPress={() => router.push({ pathname: '/(high_school)/[subject]/quiz', params: { subject, topic } })}
      ...
      <View className="flex-1 px-5 pt-8">
        {loading ? (
          <View className="flex-1 items-center justify-center">
            ...
            <Text className="text-white text-2xl font-bold font-syne text-center mb-3">Architecting Path...</Text>
            <Text className="text-[#8a8fa3] text-center font-dmsans max-w-[280px] leading-6">
               Tailoring KICD-aligned content for your focus on "**{topic}**".
            </Text>
          </View>
        ) : existingRoadmap ? (
          <RoadmapView 
